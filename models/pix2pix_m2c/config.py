...
class DataConfig(BaseSettings):
    ...
    manifest_path: str = Field(default="/usershome/cs671_user4/SynthRAD2023_Dataset/manifest.csv", validation_alias="MANIFEST_PATH")
...
class Settings(DataConfig, TrainingConfig):
    project_name: str = Field(default="pix2pix_brain_m2c", validation_alias="PROJECT_NAME")
    ...
    eval_visuals_every_epochs: int = Field(default=5, validation_alias="EVAL_VISUALS_EVERY")
